...
type ResolverRoot interface {
	...
	User() UserResolver
	WatchHistory() WatchHistoryResolver
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Content.reviews":
		if e.ComplexityRoot.Content.Reviews == nil {
			break
		}
	...
	case "Review.profile":
		...
		return e.ComplexityRoot.Review.Profile(childComplexity), true
	case "Review.rating":
...
var sources = []*ast.Source{
	{Name: "../schemas/auth.graphqls", Input: `directive @auth on FIELD_DEFINITION
directive @hasRole(role: UserRole!) on FIELD_DEFINITION
directive @profileSelectionIsRequired on FIELD_DEFINITION
...
`, BuiltIn: false},
	{Name: "../schemas/content.graphqls", Input: `type Content {
  id: ID!
  title: String!
  description: String!
  releaseDate: String!
...
`, BuiltIn: false},
	{Name: "../schemas/episode.graphqls", Input: `type Episode {
  id: ID!
  seriesId: ID!
  season: Int!
  episodeNumber: Int!
...
`, BuiltIn: false},
	{Name: "../schemas/profile.graphqls", Input: `type Profile {
  id: ID!
  userId: ID!
  name: String!
...
`, BuiltIn: false},
	{Name: "../schemas/review.graphqls", Input: `type Review {
  id: ID!
  profile: Profile!
...
extend type Query {
  getReview(id: ID!): Review @profileSelectionIsRequired @auth
}

extend type Mutation {
  createReview(input: CreateReviewInput!): Review! @profileSelectionIsRequired @hasRole(role: MEMBER) @auth
  updateReview(id: ID!, input: UpdateReviewInput!): Review! @profileSelectionIsRequired @hasRole(role: MEMBER) @auth
  deleteReview(id: ID!): Boolean! @profileSelectionIsRequired @hasRole(role: MEMBER) @auth
}
`, BuiltIn: false},
	{Name: "../schemas/schema.graphqls", Input: `type Mutation
type Query
...
extend type Query {
  ...
  listUsers: [User!]! @hasRole(role: ADMIN) @auth
}
...
`, BuiltIn: false},
	{Name: "../schemas/watchHistory.graphqls", Input: `type WatchHistory {
  id: ID!
...
func (ec *executionContext) _Content_reviews(ctx context.Context, field graphql.CollectedField, obj *model.Content) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		ec.fieldContext_Content_reviews,
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Content().Reviews(ctx, obj)
		},
		nil,
...
func (ec *executionContext) fieldContext_Content_reviews(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Content",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Review_profile(ctx context.Context, field graphql.CollectedField, obj *model.Review) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		ec.fieldContext_Review_profile,
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Review().Profile(ctx, obj)
		},
		nil,
		ec.marshalNProfile2ᚖgithubᚗcomᚋecbDeveloperᚋnetflixᚑarchitectureᚋappsᚋapiᚋinternalᚋgraphᚋmodelᚐProfile,
		true,
...
func (ec *executionContext) fieldContext_Review_profile(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Review",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _WatchedContent(ctx context.Context, sel ast.SelectionSet, obj model.WatchedContent) graphql.Marshaler {
	...
	default:
		if typedObj, ok := obj.(graphql.Marshaler); ok {
			...
			panic(fmt.Errorf("unexpected type %T; non-generated variants of WatchedContent must implement graphql.Marshaler", obj))
		}
	}
}
	...
	for i, field := range fields {
		...
		case "reviews":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Content_reviews(ctx, field, obj)
				return res
			}
	...
	for i, field := range fields {
		...
		case "profile":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Review_profile(ctx, field, obj)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
